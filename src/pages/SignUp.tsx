            ...
            {currentStep === 1 ? (
              <div className="space-y-4 sm:space-y-5 mb-2 sm:mb-0">
                ...
                <div className="pt-4">
                  ...
                  >
                    Continue
                    <ArrowRight className="ml-2 h-4 w-4 text-accent-100" />
                  </motion.button>
                </div>
              </div>
            ) : (
              <div className="space-y-4 sm:space-y-5 mb-2 sm:mb-0">
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                    I agree to the <a href="#" className="text-accent-600 hover:text-accent-500">Terms of Service</a> and <a href="#" className="text-accent-600 hover:text-accent-500">Privacy Policy</a>
                  </label>
                </div>
                ...
                <div className="flex flex-col space-y-3 pt-4">
                  ...
                  <motion.button
                    ...
                    className="w-full py-2 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500 transition-colors"
                  >
                    Back
                  </motion.button>
                </div>
