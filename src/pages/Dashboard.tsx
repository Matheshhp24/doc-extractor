      ...
      <div className="container mx-auto">
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            ...
            >
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Document Text Extraction</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <div className="p-6">
                  ...
                  <AnimatePresence>
                    {status === 'success' && (
                      ...
                      >
                        <button
                          onClick={handleCopy}
                          className="p-2 bg-white rounded-full shadow-md hover:bg-gray-100 transition-colors focus:outline-none"
                ...
                {status === 'success' && (
                  <div className="mt-4">
                    <h3 className="text-sm font-medium text-gray-700 mb-2">Editing Options</h3>
